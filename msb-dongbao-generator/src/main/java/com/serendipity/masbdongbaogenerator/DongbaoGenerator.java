package com.serendipity.masbdongbaogenerator;
 ...
 * Author: 11931
 * Date: 2021/12/9 19:49
 * FileName: com.serendipity.masbdongbaogenerator.DongbaoGenerator
...
public class DongbaoGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\document\\idea\\msb-dongbao-mall-parent-v1\\msb-dongbao-service\\msb-dongbao-ums\\src\\main\\java");
        gc.setAuthor("赵旭");
        ...
        dsc.setUrl("jdbc:mysql://1.15.149.196:33306/msb_dongbao_test?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
        ...
        pc.setParent("com.serendipity.msbdongbaoums");
        pc.setEntity("entity");
        pc.setMapper("mapper");
